...
public class EmergencyDAO {
		...
		try {
			...
			while (rs.next()){
				retVal.add(new EmergencyCall(rs.getInt("id"), rs.getString("title"), rs.getString("description"),
					rs.getDate("date"), rs.getString("location"),rs.getString("image_src"), rs.getBoolean("is_deleted"),
	...
	public static boolean insertEmergencyCall(EmergencyCall call) {
		...
		Object values[] = { call.getTitle(),call.getDescription(),new Date(call.getDate().getTime()), call.getLocation(), call.getImageSource(),
